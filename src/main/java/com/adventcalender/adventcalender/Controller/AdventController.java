...
public class AdventController {
    ...
    @ApiOperation(value = "Get Initial Doors")
    @CrossOrigin(origins = {"http://localhost:3000", "https://adventskalenderapp.herokuapp.com"})
    @GetMapping("/initial")
    ...
    @ApiOperation(value = "Get Single Door on Click")
    @CrossOrigin(origins = {"http://localhost:3000", "https://adventskalenderapp.herokuapp.com"})
    @PostMapping("post")
    public CalenderDoor getSingleDoor(@RequestParam(value = "date", required = true) final String date) throws Exception {
